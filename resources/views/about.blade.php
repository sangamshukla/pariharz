        ...
        <div class="row">
            ...
            <div class="col-md-6 col-sm-12 col-xs-12">
                <figure class="img-box">
                    <a href="#"><img src="{{asset('asset/images/resource/12.jpg')}}" alt=""></a>
                </figure>
            </div>
        </div>
    </div>
...
<section class="parallax center" style="background-image: url({{asset('asset/images/background/1.jpg')}});">
    <div class="container">
            ...
            <div class="col-md-11 col-sm-10 col-xs-10">
                ...
                <ul class="bxslider ">
                    <li>
                        <div class="clearfix">
                            <figure class="img-box pull-left">
                                <a href="#"><img src="{{asset('asset/images/resource/history.jpg')}}" alt=""></a>
                            </figure>
                            <div class="content">
                    ...
                    <li>
                        <div class="clearfix">
                            <figure class="img-box pull-left">
                                <a href="#"><img src="{{asset('asset/images/resource/history2.jpg')}}" alt=""></a>
                            </figure>
                            <div class="content">
                                <h4>Award For Best Service</h4>
                                <p class="theme-color">21st January 1975</p>
                    ...
                    <li>
                        <div class="clearfix">
                            <figure class="img-box pull-left">
                                <a href="#"><img src="{{asset('asset/images/resource/history3.jpg')}}" alt=""></a>
                            </figure>
                            <div class="content">
                                <h4>Award For Best Service</h4>
                                <p class="theme-color">21st January 1975</p>
                    ...
                    <li>
                        <div class="clearfix">
                            <figure class="img-box pull-left">
                                <a href="#"><img src="{{asset('asset/images/resource/history4.jpg')}}" alt=""></a>
                            </figure>
                            <div class="content">
                                <h4>Award For Best Service</h4>
                                <p class="theme-color">21st January 1975</p>
                    ...
                    <li>
                        <div class="clearfix">
                            <figure class="img-box pull-left">
                                <a href="#"><img src="{{asset('asset/images/resource/history5.jpg')}}" alt=""></a>
                            </figure>
                            <div class="content">
                                <h4>Award For Best Service</h4>
                                <p class="theme-color">21st January 1975</p>
                    ...
                    <li>
                        <div class="clearfix">
                            <figure class="img-box pull-left">
                                <a href="#"><img src="{{asset('asset/images/resource/history6.jpg')}}" alt=""></a>
                            </figure>
                            <div class="content">
                                <h4>Award For Best Service</h4>
                                <p class="theme-color">21st January 1975</p>
        ...
        <div class="row">
            <article class="col-md-3 col-sm-6 col-xs-12">
                <div class="single-team-member">
                    <figure class="img-box">
                        <a href="#"><img src="{{asset('asset/images/team/t1.jpg')}}" alt=""></a>
                        <div class="overlay">
                            <div class="inner-box">
                                <ul class="social">
            ...
            <article class="col-md-3 col-sm-6 col-xs-12">
                <div class="single-team-member">
                    <figure class="img-box">
                        <a href="#"><img src="{{asset('asset/images/team/t2.jpg')}}" alt=""></a>
                        <div class="overlay">
                            <div class="inner-box">
                                <ul class="social">
                                    <li><a href="#"><i class="fa fa-facebook"></i></a></li>
            ...
            <article class="col-md-3 col-sm-6 col-xs-12">
                <div class="single-team-member">
                    <figure class="img-box">
                        <a href="#"><img src="{{asset('asset/images/team/t3.jpg')}}" alt=""></a>
                        <div class="overlay">
                            <div class="inner-box">
                                <ul class="social">
                                    <li><a href="#"><i class="fa fa-facebook"></i></a></li>
            ...
            <article class="col-md-3 col-sm-6 col-xs-12">
                <div class="single-team-member">
                    <figure class="img-box">
                        <a href="#"><img src="{{asset('asset/images/team/t4.jpg')}}" alt=""></a>
                        <div class="overlay">
                            <div class="inner-box">
                                <ul class="social">
                                    <li><a href="#"><i class="fa fa-facebook"></i></a></li>
...
<section class="subscribe center sec-padd" style="background-image: url({{asset('asset/images/background/2.jpg')}});">
    <div class="container">
        <div class="row">
...
<section class="achive sec-padd">
    <div class="container">
        ...
        <div class="achive-carousel">
            <figure class="item">
                <a href="#"><img src="{{asset('asset/images/resource/achive1.jpg')}}" alt=""></a>
            </figure>
            <figure class="item">
                <a href="#"><img src="{{asset('asset/images/resource/achive2.jpg')}}" alt=""></a>
            </figure>
            <figure class="item">
                <a href="#"><img src="{{asset('asset/images/resource/achive3.jpg')}}" alt=""></a>
            </figure>
            <figure class="item">
                <a href="#"><img src="{{asset('asset/images/resource/achive4.jpg')}}" alt=""></a>
            </figure>
            <figure class="item">
                <a href="#"><img src="{{asset('asset/images/resource/achive1.jpg')}}" alt=""></a>
            </figure>
